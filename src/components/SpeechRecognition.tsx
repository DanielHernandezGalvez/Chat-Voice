...
WWimport React, { useState, useEffect, ChangeEvent } from "react";
...
function SpeechRecognition() {
  ...
  const [textareaRows, setTextareaRows] = useState<number>(12);
  ...
  const updateVoice = (event: ChangeEvent<HTMLSelectElement>) => {
